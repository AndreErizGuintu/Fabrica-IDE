...
// Backs the "Offline model" label in the sidebar of TemplatesScreen (read-only
// display only -- SettingsScreen and AIPanel use useModelSelector instead,
// which also supports switching). Reads whichever model modelConfig.json
// currently points at via IPC instead of hardcoding a name, so the label
// never drifts from the model that's actually loaded.
